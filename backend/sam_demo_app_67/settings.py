"""
Django settings for sam_demo_app_67 project.
...
ROOT_URLCONF = 'sam_demo_app_67.urls'
...
WSGI_APPLICATION = 'sam_demo_app_67.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "sam-demo-app Support <support@sam-demo-app-67.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sam_demo_app_67 API",
    "DESCRIPTION": "API documentation for sam_demo_app_67 App",
    "VERSION": "v1",
}
